package com.wanou.wanandroid.weight;
...
public class FlowLayout extends ViewGroup {
    ...
    public int horizontalSpacing = UiTools.dip2px(5);
    public int verticalSpacing = UiTools.dip2px(5);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            } else if (line.lineWidth + childWidth + horizontalSpacing > invalidWidth) {
